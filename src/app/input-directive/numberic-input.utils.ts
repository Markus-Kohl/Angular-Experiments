...
const CHROME_MIN_VALIDATION_MESSAGE = 'Wert muss größer sein als';
const CHROME_MAX_VALIDATION_MESSAGE = 'Wert muss kleiner sein als';
 ...
 * @param defaultNumericValue - default value triggert if input empty.
 */
export function getFormattedValueAsNumber(
  value: string,
