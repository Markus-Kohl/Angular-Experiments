...
import {SortingTableDirective} from './dynamic-table/directives/sorting-table.directive';
...
import {CustomDecimalInput} from './custom-input/custom-decimal-input.component';
...
import {NumericInputModule} from "./custom-input/numeric-input-directive/numeric-input.module";
import {NUMERIC_DISPLAY_INPUT_LOCALE, NUMERIC_INPUT_LOCALE} from './custom-input/numeric-input-directive/locale.tokens';
import {IntegerInputDirective} from './custom-input/integer-input-directive/integer-input.directive';
import {HighlightDirective} from './highlight-directive/highlight.directive';
import { HighlightComponent } from './highlight-directive/highlight/highlight.component';
